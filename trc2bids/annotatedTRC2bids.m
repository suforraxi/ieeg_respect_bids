%% Convert annotated micromed file (.TRC) to Brain Imaging Data Structure (BIDS)
...
% author:                   Matteo Demuru 2018
% modified for cECoG data:  Dorien van Blooijs 2018


function [status,msg,output,metadata,annots] = annotatedTRC2bids_cECoG(cfg)
